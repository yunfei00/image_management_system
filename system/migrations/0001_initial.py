    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=64, unique=True, verbose_name="部门编码"
                    ),
                ),
                (
                    "leader",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("path", models.CharField(max_length=255, verbose_name="菜单路径")),
                (
                    "icon",
                    models.CharField(
                        blank=True, max_length=64, null=True, verbose_name="图标"
                    ),
                ),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("parent", "name"), name="uk_parent_name"
                    )
                ],
            },
        ),
