    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result",
                    models.TextField(blank=True, null=True, verbose_name="登录结果"),
                ),
            ],
            options={
                "verbose_name": "登录日志",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "module",
                    models.CharField(
                        db_index=True, max_length=128, verbose_name="系统模块"
                    ),
                ),
                (
                    "operator",
                    models.CharField(
                        db_index=True, max_length=64, verbose_name="操作人员"
                    ),
                ),
                (
                    "operation_time",
                ...
                (
                    "ip",
                    models.GenericIPAddressField(
                        blank=True, db_index=True, null=True, verbose_name="操作IP"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone",
                    models.CharField(max_length=20, unique=True, verbose_name="电话"),
                ),
                ("company", models.CharField(max_length=128, verbose_name="公司名称")),
                ("position", models.CharField(max_length=128, verbose_name="岗位描述")),
